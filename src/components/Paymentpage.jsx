...
function Paymentpage(){
    return(
       <div>
        <div id="fst">
        <div id="a1">
            <img id="im1"style={{ height:"20px",width:"20px"}}src={"https://img.icons8.com/material-outlined/72/back--v1.png"}/>
            <div id="i1">Back</div>
        </div>
         <div id="a2">
            <img style={{height:"93%",width:"100%"}}
            src={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTimpSzgQGtDqyD8x93cga5W2y0hUMhmxCvQg&usqp=CAU"}/>
        </div>
    </div>
    <div id="sec1">
        <div id="s1">
        ...
        <div id="sec3">
            <div id="op">
                <div class="s2">
                    <button class="b1"></button><br></br><br></br>
                    <div class="r6">Select a payment method</div>
                </div>
                <div id="s9">
                    <div>
                        <div class="c1">
                        ...
                        <div class="c2">
                            <div class="a5">HDFC Debit Card</div>
                            <div class="a6">All debit cards by HDFC Bank </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="c2">
                            <div class="a5">HDFC Credit Card</div>
                            <div class="a6">All credit cards by HDFC Bank </div>
                        </div>
                    </div>
                    <div>
                        <div class="c1">
                        ...
                        <div class="c2">
                            <div class="a5">Other Bank Debit Card</div>
                            <div class="a6">Visa, Mastercard, Maestro, Rupay </div>
                        </div>
                    </div>
                    <div>
                        <div class="c1">
                        ...
                        <div class="c2">
                            <div class="a5">Other Bank Credit Card</div>
                            <div class="a6">Visa, Mastercard, Amex</div>
                        </div>
                    </div>
                    <div>
                        <div class="c1">
                        ...
                        <div class="c2">
                            <div class="a5">HDFC Netbanking</div>
                            <div class="a6">Pay with HDFC Netbanking Account</div>
                        </div>
                    </div>
                    <div>
                        <div class="c1">
                        ...
                        <div class="c2">
                            <div class="a5">PayLater</div>
                            <div class="a6">Pay using PayLater </div>
                        </div>
                    </div>
                    <div>
                        <div class="c1">
                        ...
                        <div class="c2">
                            <div class="a5">UPI</div>
                            <div class="a6">Pay using BHIM, Tez and other UPI apps</div>
                        </div>
                    </div>
            ...
            <div id="input">
                <div class="s2">
                    <div class="r4">Amount payable is</div>
                    <div id="r5">₹.00</div><br></br>
                    <button class="b1"></button>
                </div>
                <div id="s3">
                    <p class="r6">Pay with HDFC Debit Card</p>
                    <label class="k1">Card Number</label><br></br>
                    <input type="number" id="cno" class="no"/><br></br>
                  
                    <div id="s4">
                        <div id="s5"> <label class="k1">Expiry Date</label><br></br>
                            <input type="date" id="exp" class="da"/>
                        </div>
                        <div id="s6">
                            <label class="k1">CVV</label><br> </br>
                            <input type="number" id="cvv" class="a1" placeholder="***"/>
                        </div>
                       
                    </div><br></br>
                    <label class="k1">Cardholder's Name</label><br></br>
                    <input type="text" id="name" class="no"/><br></br><br></br>
                    <button id="b3">Pay Now</button><br></br><br></br><br></br>
                    <h4 id="a3">Cancel Payment</h4><br></br><br></br><br></br><br></br>
        ...
        <div id="dig">
        <div id="dig1"> Your transaction is processed through a secure 128-bit HTTPS Internet connection.</div>
        <div id="dig2">
            <img style={{height:"20px",width:"350px"}}
